...
$html .= '<center><h1 style="color:darkred">Team Details</h1></center><br>
<center>
    ...
    $check = "select *from team where project_id=$id";
    ...
    <td>' . $row['id'] . '</td>
    <td>' . $row['con_id'] . '</td>
    <td style="text-transform:uppercase">' . $row['con_name'] . '</td>
    <td>' . $row['datetime'] . '</td>
    </tr>';
    }
$html .= '</table>
