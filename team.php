		...
		<div class="l-navbar" id="nav-bar">
			<nav class="nav">
				...
				<div class="nav_list">
						...
						<a href="team.php" class="nav_link team active"> <i class='bx bx-group nav_icon'></i> <span class="nav_name">Team</span> </a>
			...
			<div class="row">
				<table id="myTable" class="table table-bordered table-striped">
					...
					<?php
							...
							{
								$id=$_SESSION['id'];
								$sql = "SELECT * FROM team WHERE status!='Disabled' AND con_id=$id";
							}
